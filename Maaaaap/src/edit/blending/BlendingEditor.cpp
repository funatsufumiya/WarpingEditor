...
BlendingEditor::FrameID BlendingEditor::addFrame(const ofRectangle &rect, glm::vec2 h_range, glm::vec2 v_range, const geom::Quad &uv)
{
...
geom::Quad* BlendingEditor::getUVQuad(FrameID identifier)
{
	auto found = frame_.find(identifier);
