...
void ImageWithUVOverlapped(ImTextureID user_texture_id, const ImVec2& uv_a, const ImVec2& uv_b, const ImVec2& uv_c, const ImVec2& uv_d, const ImVec2& size = ImVec2(0,0), const ImVec4& base_tint_col = ImVec4(0.5f,0.5f,0.5f,1), const ImVec4& base_border_col = ImVec4(0,0,0,0), const ImVec4& overlap_tint_col = ImVec4(1,1,1,1), const ImVec4& overlap_border_col = ImVec4(0,0,0,0));
